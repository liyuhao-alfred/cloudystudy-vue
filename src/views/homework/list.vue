...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            showDetail(index) {
                let contentInfo = ''
                contentInfo = contentInfo + `作业详情：${this.tableData[index].content}<br>`;
                this.$Modal.info({
                    title: '作业信息',
                    content: contentInfo,
                })
        ...
        mounted() {
            const rechomeworkListFormRec = this.$route.params.searchForm;
            if (rechomeworkListFormRec) {
                this.searchForm = rechomeworkListFormRec;
            }
            ...
            const teacherNoRec = this.$route.params.teacherNo;
            if (teacherNoRec) {
                this.searchForm.teacherNo = []
                this.searchForm.teacherNo.push(teacherNoRec);
            }

            const studentNoRec = this.$route.params.studentNo;
            if (studentNoRec) {
                this.searchForm.studentNo = []
                this.searchForm.studentNo.push(studentNoRec);
            }
