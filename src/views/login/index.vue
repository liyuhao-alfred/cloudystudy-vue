    ...
    <div class="login-container" style="background-color: #141a48;margin: 0px;overflow: hidden;">
        ...
        <Form ref="loginForm" autoComplete="on" :model="loginForm" :rules="loginRules" class="card-box login-form">
            <Form-item prop="account">
                <Input type="text" v-model="loginForm.account" placeholder="Username" autoComplete="on">
        ...
        methods: {
            handleLogin() {
                this.$refs.loginForm.validate(valid => {
                    if (valid) {
                        this.loading = true;
                        this.$store.dispatch('action_LoginByAccountAndPassword', this.loginForm).then(() => {
            ...
            afterQRScan() {
                ...
                // if (!codeName) {
                // } else {
                //   this.$store.dispatch('action_LoginByThirdparty', codeName).then(() => {
