	...
	<div>
			...
			<Col span="24">
				...
				<div style="" class="doc-header">
					<Form :model="formItem" :label-width="85">
						...
						<Form-item label="文本域">
							<Input v-model="formItem.textarea" type="textarea" :autosize="{minRows: 2,maxRows: 100}" placeholder="请输入..."></Input>
						</Form-item>
						<Form-item>
				...
				<div style="" class="doc-header">
					<Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="85">
						...
						<Form-item label="介绍：" prop="desc">
							<Input v-model="formValidate.desc" type="textarea" :autosize="{minRows: 2,maxRows: 100}" placeholder="请输入..."></Input>
						</Form-item>
						<Form-item>
		...
		<Row>
			<Col span="24">
				...
				<div style="" class="doc-header">
					<Form ref="formDynamic" :model="formDynamic" :label-width="85">
						<Form-item v-for="(item, index) in formDynamic.items" :key="index" :label="'项目' + (index + 1)" :prop="'items.' + index + '.value'" :rules="{required: true, message: '项目' + (index + 1) +'不能为空', trigger: 'blur'}">
						...
						<Form-item>
							...
							<Button type="ghost" @click="handleReset('formDynamic')" >重置</Button>
						</Form-item>
					</Form>
