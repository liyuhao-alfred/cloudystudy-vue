<template>
    <aside class="aside-menu px-4">
        <div class="aside-options">
            ...
            <div>
                <p class="text-muted">明天提醒我考试</p>
            </div>
        </div>

        <hr>
        <h6>系统利用率</h6>
        <i-circle :size="200" :trail-width="4" :stroke-width="5" :percent="75" stroke-linecap="square"
                  stroke-color="#43a3fb">
